...
export class WhiteboardComponent implements OnInit {
  ...
  addColumn() {
    ...
    this.messageService.add({
      ...
      detail: "La columna ha sido creada correctamente",
    });
  }
  ...
  saveColumnTitle(column: Column) {
    if (this.editingColumnTitle.trim() !== "") {
      ...
      this.messageService.add({
        ...
        detail: "El título ha sido actualizado",
      });
    }
      ...
      accept: () => {
        ...
        if (columnIndex !== -1) {
          ...
          this.messageService.add({
            ...
            detail: "La columna ha sido eliminada correctamente",
          });
        }
      },
    });
  ...
  saveNewTask() {
    ...
    this.messageService.add({
      ...
      detail: "La tarea ha sido creada correctamente",
    });
  }
  ...
  saveTaskChanges() {
    ...
    this.messageService.add({
      ...
      detail: "La tarea ha sido actualizada correctamente",
    });
  }
  ...
  drop(event: CdkDragDrop<Task[]>) {
    if (event.previousContainer === event.container) {
      ...
      this.messageService.add({
        ...
        detail: "La tarea ha sido movida a otra columna",
      });
    }
  }
